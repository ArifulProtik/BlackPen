...
// HasNotess applies the HasEdge predicate on the "notess" edge.
func HasNotess() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(NotessTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, NotessTable, NotessColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasNotessWith applies the HasEdge predicate on the "notess" edge with a given conditions (other predicates).
func HasNotessWith(preds ...predicate.Notes) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(NotessInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, NotessTable, NotessColumn),
		)
...
// HasLoves applies the HasEdge predicate on the "loves" edge.
func HasLoves() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(LovesTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2O, false, LovesTable, LovesColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasLovesWith applies the HasEdge predicate on the "loves" edge with a given conditions (other predicates).
func HasLovesWith(preds ...predicate.Love) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(LovesInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2O, false, LovesTable, LovesColumn),
		)
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
