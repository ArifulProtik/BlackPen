...
const (
	...
	FieldSlug = "slug"
	// FieldFImage holds the string denoting the f_image field in the database.
	FieldFImage = "f_image"
...
var (
	...
	// FImageValidator is a validator for the "f_image" field. It is called by the builders before save.
	FImageValidator func(string) error
