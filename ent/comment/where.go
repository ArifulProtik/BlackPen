...
func NoteID(v uuid.UUID) predicate.Comment {
	return predicate.Comment(func(s *sql.Selector) {
...
func NoteIDEQ(v uuid.UUID) predicate.Comment {
	return predicate.Comment(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldNoteID), v))
	})
}
...
func NoteIDNEQ(v uuid.UUID) predicate.Comment {
	return predicate.Comment(func(s *sql.Selector) {
...
func NoteIDIn(vs ...uuid.UUID) predicate.Comment {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func NoteIDNotIn(vs ...uuid.UUID) predicate.Comment {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func NoteIDGT(v uuid.UUID) predicate.Comment {
	return predicate.Comment(func(s *sql.Selector) {
...
func NoteIDGTE(v uuid.UUID) predicate.Comment {
	return predicate.Comment(func(s *sql.Selector) {
...
func NoteIDLT(v uuid.UUID) predicate.Comment {
	return predicate.Comment(func(s *sql.Selector) {
...
func NoteIDLTE(v uuid.UUID) predicate.Comment {
	return predicate.Comment(func(s *sql.Selector) {
