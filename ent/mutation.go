...
// LoveMutation represents an operation that mutates the Love nodes in the graph.
type LoveMutation struct {
	config
	op            Op
	typ           string
	id            *int
	...
	oldValue      func(context.Context) (*Love, error)
	predicates    []predicate.Love
}

var _ ent.Mutation = (*LoveMutation)(nil)

// loveOption allows management of the mutation configuration using functional options.
type loveOption func(*LoveMutation)

// newLoveMutation creates new mutation for the Love entity.
func newLoveMutation(c config, op Op, opts ...loveOption) *LoveMutation {
	m := &LoveMutation{
		config:        c,
		op:            op,
		typ:           TypeLove,
...
// withLoveID sets the ID field of the mutation.
func withLoveID(id int) loveOption {
	return func(m *LoveMutation) {
		var (
			err   error
			once  sync.Once
			value *Love
		)
		m.oldValue = func(ctx context.Context) (*Love, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().Love.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withLove sets the old Love of the mutation.
func withLove(node *Love) loveOption {
	return func(m *LoveMutation) {
		m.oldValue = func(context.Context) (*Love, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m LoveMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m LoveMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *LoveMutation) ID() (id int, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *LoveMutation) IDs(ctx context.Context) ([]int, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().Love.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
func (m *LoveMutation) SetNoteid(u uuid.UUID) {
	m.noteid = &u
}

// Noteid returns the value of the "noteid" field in the mutation.
func (m *LoveMutation) Noteid() (r uuid.UUID, exists bool) {
	v := m.noteid
	if v == nil {
		return
	}
...
// OldNoteid returns the old "noteid" field's value of the Love entity.
// If the Love object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *LoveMutation) OldNoteid(ctx context.Context) (v uuid.UUID, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldNoteid is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetNoteid resets all changes to the "noteid" field.
func (m *LoveMutation) ResetNoteid() {
	m.noteid = nil
}

// SetCreatedAt sets the "created_at" field.
func (m *LoveMutation) SetCreatedAt(t time.Time) {
	m.created_at = &t
}

// CreatedAt returns the value of the "created_at" field in the mutation.
func (m *LoveMutation) CreatedAt() (r time.Time, exists bool) {
	v := m.created_at
	if v == nil {
		return
	}
...
// OldCreatedAt returns the old "created_at" field's value of the Love entity.
// If the Love object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *LoveMutation) OldCreatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldCreatedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetCreatedAt resets all changes to the "created_at" field.
func (m *LoveMutation) ResetCreatedAt() {
	m.created_at = nil
}

// SetUserID sets the "user" edge to the User entity by id.
func (m *LoveMutation) SetUserID(id uuid.UUID) {
	m.user = &id
}

// ClearUser clears the "user" edge to the User entity.
func (m *LoveMutation) ClearUser() {
	m.cleareduser = true
}

// UserCleared reports if the "user" edge to the User entity was cleared.
func (m *LoveMutation) UserCleared() bool {
	return m.cleareduser
}

// UserID returns the "user" edge ID in the mutation.
func (m *LoveMutation) UserID() (id uuid.UUID, exists bool) {
	if m.user != nil {
		return *m.user, true
	}
	return
...
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// UserID instead. It exists only for internal usage by the builders.
func (m *LoveMutation) UserIDs() (ids []uuid.UUID) {
	if id := m.user; id != nil {
		ids = append(ids, *id)
	}
	return
...
// ResetUser resets all changes to the "user" edge.
func (m *LoveMutation) ResetUser() {
	m.user = nil
	m.cleareduser = false
}

// Where appends a list predicates to the LoveMutation builder.
func (m *LoveMutation) Where(ps ...predicate.Love) {
	m.predicates = append(m.predicates, ps...)
}

// Op returns the operation name.
func (m *LoveMutation) Op() Op {
	return m.op
}

// Type returns the node type of this mutation (Love).
func (m *LoveMutation) Type() string {
	return m.typ
}
...
// order to get all numeric fields that were incremented/decremented, call
// AddedFields().
func (m *LoveMutation) Fields() []string {
	fields := make([]string, 0, 2)
	if m.noteid != nil {
		fields = append(fields, love.FieldNoteid)
	}
	if m.created_at != nil {
		fields = append(fields, love.FieldCreatedAt)
	}
	return fields
}
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *LoveMutation) Field(name string) (ent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *LoveMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case love.FieldNoteid:
		return m.OldNoteid(ctx)
	case love.FieldCreatedAt:
	...
	return nil, fmt.Errorf("unknown Love field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *LoveMutation) SetField(name string, value ent.Value) error {
	switch name {
	case love.FieldNoteid:
		v, ok := value.(uuid.UUID)
		if !ok {
	...
	return fmt.Errorf("unknown Love field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *LoveMutation) AddedFields() []string {
	return nil
}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *LoveMutation) AddedField(name string) (ent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *LoveMutation) AddField(name string, value ent.Value) error {
	switch name {
	}
	return fmt.Errorf("unknown Love numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *LoveMutation) ClearedFields() []string {
	return nil
}

// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *LoveMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value of the field with the given name. It returns an
// error if the field is not defined in the schema.
func (m *LoveMutation) ClearField(name string) error {
	return fmt.Errorf("unknown Love nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *LoveMutation) ResetField(name string) error {
	switch name {
	case love.FieldNoteid:
		m.ResetNoteid()
		return nil
...
// AddedEdges returns all edge names that were set/added in this mutation.
func (m *LoveMutation) AddedEdges() []string {
	edges := make([]string, 0, 1)
	if m.user != nil {
		edges = append(edges, love.EdgeUser)
	}
	return edges
}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *LoveMutation) AddedIDs(name string) []ent.Value {
	switch name {
	case love.EdgeUser:
		if id := m.user; id != nil {
			return []ent.Value{*id}
...
// RemovedEdges returns all edge names that were removed in this mutation.
func (m *LoveMutation) RemovedEdges() []string {
	edges := make([]string, 0, 1)
	return edges
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *LoveMutation) RemovedIDs(name string) []ent.Value {
	switch name {
	}
	return nil
}
...
// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *LoveMutation) ClearedEdges() []string {
	edges := make([]string, 0, 1)
	if m.cleareduser {
		edges = append(edges, love.EdgeUser)
	}
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *LoveMutation) EdgeCleared(name string) bool {
	switch name {
	case love.EdgeUser:
		return m.cleareduser
	}
...
// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *LoveMutation) ClearEdge(name string) error {
	switch name {
	case love.EdgeUser:
		m.ClearUser()
		return nil
	}
	return fmt.Errorf("unknown Love unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *LoveMutation) ResetEdge(name string) error {
	switch name {
	case love.EdgeUser:
		m.ResetUser()
		return nil
	}
	return fmt.Errorf("unknown Love edge %s", name)
}
...
func (m *UserMutation) SetLovesID(id int) {
	m.loves = &id
}

// ClearLoves clears the "loves" edge to the Love entity.
func (m *UserMutation) ClearLoves() {
	m.clearedloves = true
}

// LovesCleared reports if the "loves" edge to the Love entity was cleared.
func (m *UserMutation) LovesCleared() bool {
	return m.clearedloves
}

// LovesID returns the "loves" edge ID in the mutation.
func (m *UserMutation) LovesID() (id int, exists bool) {
	if m.loves != nil {
		return *m.loves, true
	}
	return
...
// LovesIDs returns the "loves" edge IDs in the mutation.
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// LovesID instead. It exists only for internal usage by the builders.
func (m *UserMutation) LovesIDs() (ids []int) {
	if id := m.loves; id != nil {
		ids = append(ids, *id)
	}
	return
}

// ResetLoves resets all changes to the "loves" edge.
func (m *UserMutation) ResetLoves() {
	m.loves = nil
	m.clearedloves = false
}
...
func (m *UserMutation) AddedEdges() []string {
	...
	if m.loves != nil {
		edges = append(edges, user.EdgeLoves)
	}
	return edges
}
