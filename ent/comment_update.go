...
func (cu *CommentUpdate) SetNoteID(u uuid.UUID) *CommentUpdate {
	cu.mutation.SetNoteID(u)
	return cu
}
...
func (cu *CommentUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := cu.mutation.NoteID(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeUUID,
			Value:  value,
...
// SetNoteID sets the "note_id" field.
func (cuo *CommentUpdateOne) SetNoteID(u uuid.UUID) *CommentUpdateOne {
	cuo.mutation.SetNoteID(u)
	return cuo
}
...
func (cuo *CommentUpdateOne) sqlSave(ctx context.Context) (_node *Comment, err error) {
	...
	if value, ok := cuo.mutation.NoteID(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeUUID,
			Value:  value,
			Column: comment.FieldNoteID,
